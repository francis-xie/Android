...
import com.basic.page.utils.TitleBar;
import com.basic.page.utils.TitleUtils;
...
public abstract class PageFragment extends Fragment {
    ...
    public CoreSwitcher getSwitcher() {
        synchronized (PageFragment.this) {
     ...
     */
    public PageFragment setSwitcher(CoreSwitcher pageCoreSwitcher) {
     ...
     * @return 打开的fragment对象
     */
    public <T extends PageFragment> T openPage(Class<T> clazz, Bundle bundle, CoreAnim coreAnim) {
     ...
     * @return 打开的fragment对象
     */
    public final <T extends PageFragment> T openPageForResult(Class<T> clazz, Bundle bundle, int requestCode) {
