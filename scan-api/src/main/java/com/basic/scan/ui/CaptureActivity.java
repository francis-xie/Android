...
public class CaptureActivity extends AppCompatActivity {
    ...
    public final static String KEY_CAPTURE_THEME = "com.basic.scan.ui.KEY_CAPTURE_THEME";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        setTheme(getIntent().getIntExtra(KEY_CAPTURE_THEME, R.style.ScanTheme));
    ...
    public static AlertDialog showNoPermissionTip(final Activity activity, DialogInterface.OnClickListener listener) {
        return new AlertDialog.Builder(activity)
                .setTitle(R.string.scan_pay_attention)
                .setMessage(R.string.scan_not_get_permission)
                .setPositiveButton(R.string.scan_submit, listener)
                .show();
    }
