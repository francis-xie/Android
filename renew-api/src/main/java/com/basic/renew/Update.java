...
import com.basic.renew.logs.ILogger;
...
import com.basic.renew.proxy.impl.DefaultUpdateChecker;
import com.basic.renew.proxy.impl.DefaultUpdateDownloader;
import com.basic.renew.proxy.impl.DefaultUpdateParser;
...
public class Update {
     ...
     * @return this
     */
    public Update param(@NonNull String key, @NonNull Object value) {
        if (mParams == null) {
            mParams = new TreeMap<>();
        }
     ...
     * @return this
     */
    public Update params(@NonNull Map<String, Object> params) {
        logForParams(params);
        mParams = params;
        return this;
    }
     ...
     * @return this
     */
    public Update isGet(boolean isGet) {
     ...
     * @return this
     */
    public Update isAutoMode(boolean isAutoMode) {
     ...
     * @return this
     */
    public Update supportSilentInstall(boolean supportSilentInstall) {
     ...
     * @return this
     */
    public Update debug(boolean isDebug) {
     ...
     * @return this
     */
    public Update setILogger(@NonNull ILogger logger) {
