...
import com.basic.renew.utils.FileUtils;
import com.basic.renew.utils.UpdateUtils;

import java.io.File;

import static com.basic.renew.entity.UpdateError.ERROR.DOWNLOAD_FAILED;
...
public class DownloadService extends Service {
    ...
    private static final CharSequence CHANNEL_NAME = "update_channel_name";
...
//            channel.setVibrationPattern(new long[]{100, 200, 300, 400, 500, 400, 300, 200, 400});
    ...
    private class FileDownloadCallBack implements IUpdateHttpService.DownloadCallback {
        ...
        private void handleOnSuccess(File file) {
            ...
            try {
                if (UpdateUtils.isAppOnForeground(DownloadService.this)) {
                    ...
                    if (mIsAutoInstall) {
                        _Update.startInstallApk(DownloadService.this, file, mDownloadEntity);
                    } else {
        ...
        public void onError(Throwable throwable) {
            ...
            _Update.onUpdateError(DOWNLOAD_FAILED, throwable != null ? throwable.getMessage() : "unknown error!");
            //App前台运行
