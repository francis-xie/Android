...
import com.basic.renew.utils.ShellUtils.CommandResult;
...
public final class ApkInstallUtils {
    ...
    private static boolean installNormal(Context context, File appFile) {
        try {
            ...
            _Update.onUpdateError(INSTALL_FAILED, "Apk installation failed using the intent of the system!");
        }
        return false;
    }
    ...
    public static Intent getInstallAppIntent(File appFile) {
        try {
            ...
            _Update.onUpdateError(INSTALL_FAILED, "Failed to get intent for installation！");
        }
        return null;
    }
