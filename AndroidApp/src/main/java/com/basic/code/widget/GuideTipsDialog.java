...
import com.basic.constant.TimeConstants;
import com.basic.code.R;
import com.basic.code.core.http.api.ApiService;
import com.basic.code.core.http.callback.NoTipCallBack;
import com.basic.code.core.http.entity.TipInfo;
import com.basic.code.utils.MMKVUtils;
...
import com.basic.face.widget.dialog.BaseDialog;
...
public class GuideTipsDialog extends BaseDialog implements View.OnClickListener, CompoundButton.OnCheckedChangeListener {
    ...
    private static final String KEY_IS_IGNORE_TIPS = "com.basic.code.widget.key_is_ignore_tips_";
    ...
    public static void showTipsForce(Context context) {
        CustomRequest request = Http.custom().cacheMode(CacheMode.FIRST_CACHE).cacheTime(TimeConstants.DAY).cacheKey("getTips");
