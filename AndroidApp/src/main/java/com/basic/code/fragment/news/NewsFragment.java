...
import com.basic.code.adapter.base.broccoli.BroccoliSimpleDelegateAdapter;
...
import com.basic.code.databinding.FragmentNewsBinding;
import com.basic.code.utils.DemoDataProvider;
            ...
            protected void bindData(@NonNull RecyclerViewHolder holder, int position, AdapterItem item) {
                if (item != null) {
                    ...
                    holder.click(R.id.ll_container, v -> {
                        ...
                        // 注意: 这里由于NewsFragment是使用Viewpager加载的，并非使用Page加载的，因此没有承载Activity， 需要使用openNewPage。
