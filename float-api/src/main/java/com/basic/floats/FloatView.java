...
public abstract class FloatView implements OnTouchListener {
     ...
     * @return
     */
    public FloatView setOnFloatViewClickListener(OnClickListener onClickListener) {
     ...
     * @return
     */
    public FloatView setOnFloatViewMoveListener(OnFloatViewMoveListener onFloatViewMoveListener) {
