...
import static com.basic.tools.app.IntentUtils.DocumentType.ANY;
import static com.basic.tools.app.IntentUtils.DocumentType.AUDIO;
import static com.basic.tools.app.IntentUtils.DocumentType.IMAGE;
import static com.basic.tools.app.IntentUtils.DocumentType.VIDEO;
...
public final class IntentUtils {
    ...
    public static Intent getInstallAppIntent(final File file,
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            ...
            data = FileProvider.getUriForFile(Util.getContext(), authority, file);
        }
    ...
    public static Intent getLaunchAppIntent(final String packageName, final boolean isNewTask) {
        Intent intent = Util.getContext().getPackageManager().getLaunchIntentForPackage(packageName);
        if (intent == null) {
            return null;
        }
        return getIntent(intent, isNewTask);
