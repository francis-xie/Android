...
public class CameraSee extends FrameLayout {
    ...
    public CameraSee(Context context) {
        this(context, null);
    }

    public CameraSee(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    @SuppressWarnings("WrongConstant")
    public CameraSee(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void updateAspectRatio() {
        if (mAspectRatioString != null) {
            ...
            setAspectRatio(_CameraSee.getDefaultAspectRatio());
        }
    }
     ...
     * {@link Callback#onPictureTaken(CameraSee, byte[])}.
     */
    public void takePicture() {
        mImpl.takePicture();
    }

    private class CallbackBridge implements CameraSeeImpl.Callback {
        ...
        public void onCameraOpened() {
            ...
            for (Callback callback : mCallbacks) {
                callback.onCameraOpened(CameraSee.this);
            }
        }
        ...
        public void onCameraClosed() {
            for (Callback callback : mCallbacks) {
                callback.onCameraClosed(CameraSee.this);
            }
        }
        ...
        public void onPictureTaken(byte[] data) {
            for (Callback callback : mCallbacks) {
                callback.onPictureTaken(CameraSee.this, data);
            }
        }
    ...
    /**
     * Callback for monitoring events about {@link CameraSee}.
     */
    ...
    public abstract static class Callback {
         ...
         *
         * @param cameraSee The associated {@link CameraSee}.
         */
         ...
         */
        public void onPictureTaken(CameraSee cameraSee, byte[] data) {
        }
    }
