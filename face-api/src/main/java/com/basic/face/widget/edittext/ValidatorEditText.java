...
public class ValidatorEditText extends AppCompatEditText implements View.OnFocusChangeListener {
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (!TextUtils.isEmpty(regexp)) {
            ...
            if (!TextUtils.isEmpty(errorMessage)) {
                ...
                mValidators.add(new RegexpValidator(ResUtils.getString(R.string.face_met_input_error), regexp));
            }
        }
        ...
        if (mErrorDrawable == null) {
            ...
            if (mErrorDrawable == null) {
                mErrorDrawable = ResUtils.getDrawable(getContext(), R.drawable.face_ic_default_tip_btn);
            }
        }
    ...
    private void showErrorMsg() {
        if (!mIsValid) {
            ViewTooltip
                    .on(this)
                    .color(ThemeUtils.resolveColor(getContext(), R.attr.face_config_color_error_text))
    ...
    public void setError(CharSequence error) {
        ...
        if (TextUtils.isEmpty(error)) {
            setErrorIconVisible(false);
            setBackground(ResUtils.getDrawable(getContext(), R.drawable.face_config_bg_edittext));
        } else {
            onValidateError(error.toString());
            setBackground(ResUtils.getDrawable(getContext(), R.drawable.face_config_color_edittext_error));
        }
    }
