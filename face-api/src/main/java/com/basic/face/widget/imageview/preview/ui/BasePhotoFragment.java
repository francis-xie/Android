...
import com.basic.face.widget.imageview.photoview.PhotoViewAttacher;
...
import com.basic.face.widget.imageview.preview.loader.ISimpleTarget;
...
import com.basic.face.widget.progress.materialprogressbar.MaterialProgressBar;
...
public class BasePhotoFragment extends Fragment {
     ...
     * 预览图片 类型
     */
    public static final String KEY_TRANS_PHOTO = "com.basic.face.widget.preview.KEY_TRANS_PHOTO";
    public static final String KEY_SING_FILING = "com.basic.face.widget.preview.KEY_SING_FILING";
    public static final String KEY_PREVIEW_ITEM = "com.basic.face.widget.preview.KEY_PREVIEW_ITEM";
    public static final String KEY_DRAG = "com.basic.face.widget.preview.KEY_DRAG";
    public static final String KEY_SENSITIVITY = "com.basic.face.widget.preview.KEY_SENSITIVITY";
    public static final String KEY_PROGRESS_COLOR = "com.basic.face.widget.preview.KEY_PROGRESS_COLOR";
    ...
    private void initArgs() {
        ...
        if (bundle != null) {
            int colorId = bundle.getInt(KEY_PROGRESS_COLOR, R.color.face_config_color_main_theme);
