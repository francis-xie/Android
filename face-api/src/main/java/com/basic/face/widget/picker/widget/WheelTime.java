...
package com.basic.face.widget.picker.widget;

import android.view.View;

import com.basic.face.R;
import com.basic.face.widget.picker.wheelview.WheelView;
import com.basic.face.widget.picker.wheelview.listener.OnItemSelectedListener;
import com.basic.face.widget.picker.widget.adapter.ArrayWheelAdapter;
import com.basic.face.widget.picker.widget.adapter.NumericWheelAdapter;
import com.basic.face.widget.picker.widget.listener.ISelectTimeCallback;
import com.basic.face.widget.picker.widget.utils.ChinaDateUtils;
import com.basic.face.widget.picker.widget.utils.LunarCalendarUtils;
...
//                maxItem = endD;
    ...
    public void setLabels(String label_year, String label_month, String label_day, String label_hours, String label_mins, String label_seconds) {
        ...
        if (label_year != null) {
            ...
            wv_year.setLabel(view.getContext().getString(R.string.face_picker_view_year));
        }
        if (label_month != null) {
            wv_month.setLabel(label_month);
        } else {
            wv_month.setLabel(view.getContext().getString(R.string.face_picker_view_month));
        }
        if (label_day != null) {
            wv_day.setLabel(label_day);
        } else {
            wv_day.setLabel(view.getContext().getString(R.string.face_picker_view_day));
        }
        if (label_hours != null) {
            wv_hours.setLabel(label_hours);
        } else {
            wv_hours.setLabel(view.getContext().getString(R.string.face_picker_view_hours));
        }
        if (label_mins != null) {
            wv_minutes.setLabel(label_mins);
        } else {
            wv_minutes.setLabel(view.getContext().getString(R.string.face_picker_view_minutes));
        }
        if (label_seconds != null) {
            wv_seconds.setLabel(label_seconds);
        } else {
            wv_seconds.setLabel(view.getContext().getString(R.string.face_picker_view_seconds));
        }
