...
package com.basic.face.widget.picker.widget.configure;
...
import com.basic.face.widget.picker.widget.listener.CustomListener;
import com.basic.face.widget.picker.widget.listener.OnOptionsSelectChangeListener;
import com.basic.face.widget.picker.widget.listener.OnOptionsSelectListener;
import com.basic.face.widget.picker.widget.listener.OnTimeSelectChangeListener;
import com.basic.face.widget.picker.widget.listener.OnTimeSelectListener;
...
public class PickerOptions {
    ...
    public PickerOptions(int buildType) {
        if (buildType == TYPE_PICKER_OPTIONS) {
            layoutRes = R.layout.face_layout_picker_view_options;
        } else {
            layoutRes = R.layout.face_layout_picker_view_time;
        }
    }
