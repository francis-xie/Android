...
import com.basic.face.widget.dialog.materialdialog.internal.MDButton;
...
import com.basic.face.widget.dialog.materialdialog.internal.ThemeSingleton;
import com.basic.face.widget.dialog.materialdialog.util.RippleHelper;
...
public class MaterialDialog extends DialogBase
    ...
    public static class Builder {
        ...
        public Builder(@NonNull Context context) {
            ...
            final String mediumFont = ThemeUtils.resolveString(context, R.attr.md_medium_font, FACE.getDefaultFontAssetPath());
            final String regularFont = ThemeUtils.resolveString(context, R.attr.md_regular_font, FACE.getDefaultFontAssetPath());
            try {
        ...
        public Builder inputRange(
            ...
            if (errorColor == 0) {
                this.inputRangeErrorColor = ThemeUtils.resolveColor(context, R.attr.face_config_color_error_text);
            } else {
