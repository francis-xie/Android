...
import com.basic.face.widget.alpha.FACEAlphaButton;
...
public class FACEButton extends FACEAlphaButton implements IFACELayout {
    ...
    public FACEButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs, 0);
    }

    public FACEButton(Context context, AttributeSet attrs, int defStyleAttr) {
