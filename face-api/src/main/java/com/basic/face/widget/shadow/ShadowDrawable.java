package com.basic.face.widget.shadow;
...
import static com.basic.face.widget.shadow.ShadowDrawable.Builder.DEFAULT_SHADOW_COLOR;
...
public class ShadowDrawable extends Drawable {
    ...
    public static ShadowDrawable fromAttributeSet(Context context, AttributeSet attrs) {
        ...
        int bgColor = typedArray.getColor(R.styleable.ShadowDrawable_sd_bgColor, ResUtils.getColor(R.color.face_config_color_white));
