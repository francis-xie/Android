...
package com.basic.face.widget.tabbar;
...
public class TabSegment extends HorizontalScrollView {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mNormalColor = array.getColor(R.styleable.TabSegment_ts_normal_color, ContextCompat.getColor(context, R.color.face_config_color_gray_5));
        mHasIndicator = array.getBoolean(R.styleable.TabSegment_ts_has_indicator, true);
        mIndicatorHeight = array.getDimensionPixelSize(R.styleable.TabSegment_ts_indicator_height, getResources().getDimensionPixelSize(R.dimen.face_tab_segment_indicator_height));
        mTabTextSize = array.getDimensionPixelSize(R.styleable.TabSegment_android_textSize, getResources().getDimensionPixelSize(R.dimen.face_tab_segment_text_size));
    ...
    public static class Tab {
        ...
        private TextView ensureSignCountView(Context context) {
            if (mSignCountTextView == null) {
                mSignCountTextView = new TextView(context, null, R.attr.face_tab_sign_count_view);
                RelativeLayout.LayoutParams signCountLp = new RelativeLayout.LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, ThemeUtils.resolveDimension(context, R.attr.face_tab_sign_count_view_minSize));
                signCountLp.addRule(RelativeLayout.ALIGN_TOP, R.id.face_tab_segment_item_id);
                signCountLp.addRule(RelativeLayout.RIGHT_OF, R.id.face_tab_segment_item_id);
        ...
        public void showSignCountView(Context context, int count) {
            ...
            if (count != 0) {
                // 显示未读数
                signCountLp.height = ThemeUtils.resolveDimension(mSignCountTextView.getContext(), R.attr.face_tab_sign_count_view_minSize_with_text);
                mSignCountTextView.setLayoutParams(signCountLp);
                mSignCountTextView.setMinHeight(ThemeUtils.resolveDimension(mSignCountTextView.getContext(), R.attr.face_tab_sign_count_view_minSize_with_text));
                mSignCountTextView.setMinWidth(ThemeUtils.resolveDimension(mSignCountTextView.getContext(), R.attr.face_tab_sign_count_view_minSize_with_text));
                mSignCountTextView.setText(getNumberDigitsFormattingValue(count));
            } else {
                // 显示红点
                signCountLp.height = ThemeUtils.resolveDimension(mSignCountTextView.getContext(), R.attr.face_tab_sign_count_view_minSize);
                mSignCountTextView.setLayoutParams(signCountLp);
                mSignCountTextView.setMinHeight(ThemeUtils.resolveDimension(mSignCountTextView.getContext(), R.attr.face_tab_sign_count_view_minSize));
                mSignCountTextView.setMinWidth(ThemeUtils.resolveDimension(mSignCountTextView.getContext(), R.attr.face_tab_sign_count_view_minSize));
    ...
    public class TabAdapter extends FACEItemViewsAdapter<Tab, TabItemView> {
        ...
        protected void bind(Tab item, TabItemView view, int position) {
            ...
            if (mCustomViews != null && mCustomViews.size() > 0) {
                view.setTag(R.id.face_view_can_not_cache_tag, true);
    ...
    public class TabItemView extends RelativeLayout {
        ...
        public TabItemView(Context context) {
            ...
            mTextView.setTypeface(FACE.getDefaultTypeface());
            // 用于提供给customView布局用
            mTextView.setId(R.id.face_tab_segment_item_id);
