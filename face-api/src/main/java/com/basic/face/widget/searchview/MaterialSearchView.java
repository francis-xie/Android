...
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    private void initiateView(Context context) {
        mContext = context;
        LayoutInflater.from(mContext).inflate(R.layout.face_layout_search_view, this, true);
    ...
    private void onVoiceClicked() {
        try {
            ...
            Toast.makeText(getContext(), R.string.face_tip_no_recognize_speech, Toast.LENGTH_SHORT).show();
        }
    }
