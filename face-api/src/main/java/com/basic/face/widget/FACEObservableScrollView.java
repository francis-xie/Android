 ...
 * </p>
 */
public class FACEObservableScrollView extends ScrollView {

    private int mScrollOffset = 0;

    private List<OnScrollChangedListener> mOnScrollChangedListeners;

    public FACEObservableScrollView(Context context) {
        super(context);
    }

    public FACEObservableScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FACEObservableScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public interface OnScrollChangedListener {
         ...
         * @param oldt 原先的Y轴的位置
         */
        void onScrollChanged(FACEObservableScrollView scrollView, int l, int t, int oldl, int oldt);
    }
