...
public class EditSpinner extends FrameLayout implements View.OnClickListener, AdapterView.OnItemClickListener, TextWatcher {
    ...
    private void initView(Context context) {
        LayoutInflater.from(context).inflate(R.layout.face_layout_edit_spinner, this);
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setTextSize(typedArray.getDimensionPixelSize(R.styleable.EditSpinner_es_textSize, ThemeUtils.resolveDimension(getContext(), R.attr.face_config_size_spinner_text)));
    ...
    private ListPopupWindow buildPopupWindow() {
        ...
        popupWindow.setListSelector(ResUtils.getDrawable(getContext(), R.drawable.face_config_list_item_selector));
