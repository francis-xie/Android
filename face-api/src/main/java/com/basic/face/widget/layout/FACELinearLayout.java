 ...
 */
public class FACELinearLayout extends FACEAlphaLinearLayout implements IFACELayout {
    ...
    public FACELinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
