...
public class FACEAlphaLinearLayout extends LinearLayout {
    ...
    public FACEAlphaLinearLayout(Context context) {
        super(context);
    }

    public FACEAlphaLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FACEAlphaLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
