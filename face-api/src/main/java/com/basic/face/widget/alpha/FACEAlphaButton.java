...
public class FACEAlphaButton extends AppCompatButton {
    ...
    public FACEAlphaButton(Context context) {
        super(context);
    }

    public FACEAlphaButton(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FACEAlphaButton(Context context, AttributeSet attrs, int defStyleAttr) {
