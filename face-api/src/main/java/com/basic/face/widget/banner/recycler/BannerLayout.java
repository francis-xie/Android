...
package com.basic.face.widget.banner.recycler;
...
import com.basic.face.widget.banner.recycler.layout.BannerLayoutManager;
import com.basic.face.widget.banner.recycler.layout.CenterSnapHelper;
...
public class BannerLayout extends FrameLayout {
    ...
    protected void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int indicatorSelectedColor = typedArray.getColor(R.styleable.BannerLayout_bl_indicatorSelectedColor, ResUtils.getColor(R.color.face_config_color_red));
        int indicatorUnselectedColor = typedArray.getColor(R.styleable.BannerLayout_bl_indicatorUnselectedColor, ResUtils.getColor(R.color.face_config_color_gray_2));
