...
public class HorizontalProgressView extends View {
    ...
    private void obtainAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mStartColor = typedArray.getColor(R.styleable.HorizontalProgressView_hpv_start_color, getResources().getColor(R.color.face_config_color_light_orange));
        mEndColor = typedArray.getColor(R.styleable.HorizontalProgressView_hpv_end_color, getResources().getColor(R.color.face_config_color_dark_orange));
