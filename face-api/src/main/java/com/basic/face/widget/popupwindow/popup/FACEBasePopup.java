...
public abstract class FACEBasePopup {
     ...
     */
    public FACEBasePopup(Context context) {
        mContext = context;
     ...
     * @param listener
     */
    public FACEBasePopup setOnDismissListener(PopupWindow.OnDismissListener listener) {
    ...
    public class RootView extends FrameLayout {
        ...
        protected void onConfigurationChanged(Configuration newConfig) {
            ...
            FACEBasePopup.this.onConfigurationChanged(newConfig);
