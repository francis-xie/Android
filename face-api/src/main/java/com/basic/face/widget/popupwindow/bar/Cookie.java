...
package com.basic.face.widget.popupwindow.bar;
...
final class Cookie extends LinearLayout {
    ...
    private void initViews(Context context) {
        inflate(getContext(), R.layout.face_layout_cookie, this);
    ...
    public void setParams(final CookieBar.Params params) {
        if (params != null) {
            ...
            int padding = ThemeUtils.resolveDimension(getContext(), R.attr.face_config_content_spacing_horizontal);
