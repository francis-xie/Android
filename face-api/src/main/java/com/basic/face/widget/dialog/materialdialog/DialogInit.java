...
import com.basic.face.widget.FACEKeyboardScrollView;
import com.basic.face.widget.dialog.materialdialog.internal.MDAdapter;
...
import com.basic.face.widget.progress.materialprogressbar.HorizontalProgressDrawable;
import com.basic.face.widget.progress.materialprogressbar.IndeterminateCircularProgressDrawable;
import com.basic.face.widget.progress.materialprogressbar.IndeterminateHorizontalProgressDrawable;
...
class DialogInit {
    ...
    public static void init(final MaterialDialog dialog) {
        ...
        over scroll glow without clipping */
                ...
                final ScrollView sv = new FACEKeyboardScrollView(dialog.getContext());
