...
public class FACEPopup extends FACEBasePopup {
    ...
    public FACEPopup(Context context) {
        this(context, DIRECTION_NONE);
    }


    public FACEPopup(Context context, int preferredDirection) {
        super(context);
     ...
     * 设置根据计算得到的位置后的偏移值
     */
    public FACEPopup setPositionOffsetX(int offsetX) {
        mOffsetX = offsetX;
        return this;
    }
     ...
     */
    public FACEPopup setPositionOffsetYWhenTop(int offsetYWhenTop) {
     ...
     */
    public FACEPopup setPositionOffsetYWhenBottom(int offsetYWhenBottom) {
     ...
     * @return
     */
    public FACEPopup setPreferredDirection(int preferredDirection) {
        mPreferredDirection = preferredDirection;
        return this;
    }
    ...
    private void initAnimationStyle(int screenWidth, int requestedX) {
        ...
        switch (mAnimStyle) {
            case ANIM_GROW_FROM_LEFT:
                getPopupWindow().setAnimationStyle(onTop ? R.style.FACE_Animation_PopUpMenu_Left : R.style.FACE_Animation_PopDownMenu_Left);
                break;

            case ANIM_GROW_FROM_RIGHT:
                getPopupWindow().setAnimationStyle(onTop ? R.style.FACE_Animation_PopUpMenu_Right : R.style.FACE_Animation_PopDownMenu_Right);
                break;

            case ANIM_GROW_FROM_CENTER:
                getPopupWindow().setAnimationStyle(onTop ? R.style.FACE_Animation_PopUpMenu_Center : R.style.FACE_Animation_PopDownMenu_Center);
                break;
            case ANIM_AUTO:
    ...
    public void setContentView(View root) {
        FrameLayout container = (FrameLayout) LayoutInflater.from(getContext()).inflate(R.layout.face_layout_popup, null, false);
    ...
    public void showDown(View v) {
        setPreferredDirection(FACEPopup.DIRECTION_BOTTOM);
        show(v);
    }
    ...
    public void showUp(View v) {
        setPreferredDirection(FACEPopup.DIRECTION_TOP);
        show(v);
    }
    ...
    protected int getPopupWidth() {
        int width;
        switch (FACE.getScreenType()) {
            case UIConsts.ScreenType.BIG_TABLET:
                width = ResUtils.getDimensionPixelSize(R.dimen.face_popup_width_tablet_big);
                break;
            case UIConsts.ScreenType.SMALL_TABLET:
                width = ResUtils.getDimensionPixelSize(R.dimen.face_popup_width_tablet_small);
                break;
            case UIConsts.ScreenType.PHONE:
                width = ResUtils.getDimensionPixelSize(R.dimen.face_popup_width_phone);
                break;
            default:
                width = ResUtils.getDimensionPixelSize(R.dimen.face_popup_width_tablet_small);
                break;
