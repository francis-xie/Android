...
package com.basic.face.widget.progress;
...
public class CircleProgressView extends View {
     ...
     */
    private int mStartColor = getResources().getColor(R.color.face_config_color_light_orange);
    /**
     * the color of end progress
     */
    private int mEndColor = getResources().getColor(R.color.face_config_color_dark_orange);
    /**
    ...
    private void obtainAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mStartColor = typedArray.getColor(R.styleable.CircleProgressView_cpv_start_color, getResources().getColor(R.color.face_config_color_light_orange));
        mEndColor = typedArray.getColor(R.styleable.CircleProgressView_cpv_end_color, getResources().getColor(R.color.face_config_color_dark_orange));
    ...
    private void drawProgressText(Canvas canvas) {
        if (textVisibility) {
            ...
            mTextPaint.setTypeface(FACE.getDefaultTypeface());
