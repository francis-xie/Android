...
package com.basic.face.widget.progress.loading;
...
public class LoadingViewLayout extends LinearLayout implements IMessageLoader {
    ...
    private void initView(Context context) {
        LayoutInflater.from(context).inflate(R.layout.face_layout_loading_view, this, true);
    ...
    private void initLayoutStyle(Context context) {
        ...
        setVisibility(GONE);
        int padding = ThemeUtils.resolveDimension(context, R.attr.face_dialog_loading_padding_size);
        setPadding(padding, padding, padding, padding);
        int minSize = ThemeUtils.resolveDimension(context, R.attr.face_dialog_loading_min_size);
