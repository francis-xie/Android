...
public class OptionsPickerView<T> extends BasePickerView implements View.OnClickListener, HasTypeface {
    ...
    private void initView(Context context) {
        ...
        if (mPickerOptions.customListener == null) {
            if (isDialog()) {
                LayoutInflater.from(context).inflate(R.layout.face_layout_picker_view_options_dialog, contentContainer);
            } else {
                LayoutInflater.from(context).inflate(R.layout.face_layout_picker_view_options, contentContainer);
            }
        ...
        if (FACE.getDefaultTypeface() == null) {
