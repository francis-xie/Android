...
import com.basic.face.logs.UILog;
...
public class BottomSheet extends Dialog {
    ...
    public static class BottomListSheetBuilder {
        ...
        private boolean needToScroll() {
            int itemHeight = ThemeUtils.resolveDimension(mContext, R.attr.face_bottom_sheet_list_item_height);
            ...
            if (mTitleTv != null && !Utils.isNullOrEmpty(mTitle)) {
                totalHeight += ThemeUtils.resolveDimension(mContext, R.attr.face_bottom_sheet_title_height);
            }
        ...
        protected int getContentViewLayoutId() {
            return R.layout.face_bottom_sheet_list;
        }
        ...
        private class ListAdapter extends BaseAdapter {
            ...
            public View getView(final int position, View convertView, ViewGroup parent) {
                ...
                if (convertView == null) {
                    ...
                    convertView = inflater.inflate(R.layout.face_bottom_sheet_list_item, parent, false);
    ...
    public static class BottomGridSheetBuilder {
        ...
        protected int getContentViewLayoutId() {
            return R.layout.face_bottom_sheet_grid;
        }

        protected int getItemViewLayoutId() {
            return R.layout.face_bottom_sheet_grid_item;
        }
        ...
        private int calculateItemWidth(int width, int maxItemCountInEachLine, int paddingLeft, int paddingRight) {
            if (mMiniItemWidth == -1) {
                mMiniItemWidth = ThemeUtils.resolveDimension(mContext, R.attr.face_bottom_sheet_grid_item_mini_width);
            }
