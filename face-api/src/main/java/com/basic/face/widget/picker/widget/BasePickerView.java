...
import com.basic.face.widget.picker.widget.listener.OnDismissListener;
import com.basic.face.widget.picker.widget.utils.PickerViewAnimateUtils;
...
public class BasePickerView {
    ...
    protected void initViews() {
        ...
        if (isDialog()) {
            //如果是对话框模式
            dialogView = (ViewGroup) layoutInflater.inflate(R.layout.face_layout_picker_view_base, null, false);
            //设置界面的背景为透明
            ...
            //将控件添加到decorView中
            rootView = (ViewGroup) layoutInflater.inflate(R.layout.face_layout_picker_view_base, mPickerOptions.decorView, false);
    ...
    public void createDialog() {
        if (dialogView != null) {
            mDialog = new Dialog(context, R.style.FACEDialog_Custom);
