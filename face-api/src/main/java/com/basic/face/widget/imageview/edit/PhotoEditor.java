...
public class PhotoEditor implements BrushViewChangeListener {
    ...
    private View getLayout(final ViewType viewType) {
        ...
        switch (viewType) {
            case TEXT:
                rootView = mLayoutInflater.inflate(R.layout.face_layout_photo_editor_text, null);
                ...
                break;
            case IMAGE:
                rootView = mLayoutInflater.inflate(R.layout.face_layout_photo_editor_image, null);
                break;
            case EMOJI:
                rootView = mLayoutInflater.inflate(R.layout.face_layout_photo_editor_text, null);
