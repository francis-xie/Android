...
public class Signer {
    ...
    public static String rsa256Sign(String content, String privateKey, String charset) throws RuntimeException {
        try {
            ...
            byte[] signed = signature.sign();
            return new String(com.alipay.easysdk.util.codec.Base64.encodeBase64(signed));
    ...
    public static PrivateKey getPrivateKeyFromPKCS8(String algorithm, InputStream ins) throws Exception {
        if (ins != null && !StringUtils.isEmpty(algorithm)) {
            ...
            encodedKey = com.alipay.easysdk.util.codec.Base64.decodeBase64(encodedKey);
    ...
    public static boolean rsa256CheckContent(String content, String sign, String publicKey, String charset) throws RuntimeException {
        try {
            ...
            return signature.verify(com.alipay.easysdk.util.codec.Base64.decodeBase64(sign.getBytes()));
        } catch (Exception var6) {
    ...
    public static String rsaEncrypt(String content, String publicKey, String charset) throws RuntimeException {
        try {
            ...
            byte[] encryptedData = com.alipay.easysdk.util.codec.Base64.encodeBase64(out.toByteArray());
            out.close();
    ...
    public static String rsaDecrypt(String content, String privateKey, String charset) throws RuntimeException {
        try {
            ...
            byte[] encryptedData = StringUtils.isEmpty(charset) ? com.alipay.easysdk.util.codec.Base64.decodeBase64(content.getBytes()) : com.alipay.easysdk.util.codec.Base64.decodeBase64(content.getBytes(charset));
