...
import com.basic.http.interceptor.InterceptorChain;
import com.basic.http.interceptor.InterceptorContext;
import com.basic.http.okhttp.ClientHelper;
import com.basic.http.okhttp.OkRequestBuilder;
...
public class Http {
    ...
    private static String composeUrl(HttpRequest request) {
    ...
    public static HttpResponse doAction(HttpRequest request) {
        return doAction(request, new HashMap<String, Object>());
    }

    public static HttpResponse doAction(HttpRequest request, Map<String, Object> runtimeOptions) {
        try {
            String urlString = Http.composeUrl(request);
            ...
            throw new HttpRetryableException(e);
        }
    }

    public static HttpResponse doAction(HttpRequest request, Map<String, Object> runtimeOptions, InterceptorChain chain) {
        if (null == chain) {
        ...
        HttpResponse response = doAction(request, runtimeOptions);
    ...
    public static boolean isRetryable(Exception e) {
        return e instanceof HttpRetryableException;
    }
