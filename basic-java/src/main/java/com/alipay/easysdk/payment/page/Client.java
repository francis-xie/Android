...
public class Client {
    ...
    public AlipayTradePagePayResponse pay(String subject, String outTradeNo, String totalAmount, String returnUrl) throws Exception {
        java.util.Map<String, String> systemParams = HttpConverter.buildMap(
            new HttpPair("method", "alipay.trade.page.pay"),
        ...
        java.util.Map<String, Object> bizParams = HttpConverter.buildMap(
            ...
            new HttpPair("product_code", "FAST_INSTANT_TRADE_PAY")
        );
        ...
        return HttpModel.toModel(response, new AlipayTradePagePayResponse());
    }
