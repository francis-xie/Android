...
public class Client {
        ...
        while (Http.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                ...
                java.util.Map<String, String> systemParams = HttpConverter.buildMap(
                    new HttpPair("method", "alipay.open.public.message.content.create"),
                ...
                java.util.Map<String, Object> bizParams = HttpConverter.buildMap(
                    new HttpPair("title", title),
                    new HttpPair("cover", cover),
                    new HttpPair("content", content),
                    new HttpPair("could_comment", contentComment),
                    new HttpPair("ctype", ctype),
                    new HttpPair("benefit", benefit),
                    new HttpPair("ext_tags", extTags),
                    new HttpPair("login_ids", loginIds)
                );
                ...
                if (_kernel.isCertMode()) {
                    if (_kernel.verify(respMap, _kernel.extractAlipayPublicKey(_kernel.getAlipayCertSN(respMap)))) {
                        return HttpModel.toModel(_kernel.toRespModel(respMap), new AlipayOpenPublicMessageContentCreateResponse());
                    }
    ...
    public AlipayOpenPublicMessageContentModifyResponse modifyImageTextContent(String contentId, String title, String cover, String content, String couldComment, String ctype, String benefit, String extTags, String loginIds) throws Exception {
        ...
        while (Http.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                HttpRequest request_ = new HttpRequest();
                java.util.Map<String, String> systemParams = HttpConverter.buildMap(
                    new HttpPair("method", "alipay.open.public.message.content.modify"),
                    new HttpPair("app_id", _kernel.getConfig("appId")),
                    new HttpPair("timestamp", _kernel.getTimestamp()),
                    new HttpPair("format", "json"),
                    new HttpPair("version", "1.0"),
                ...
                java.util.Map<String, Object> bizParams = HttpConverter.buildMap(
                    new HttpPair("content_id", contentId),
                    new HttpPair("title", title),
                    new HttpPair("cover", cover),
                    new HttpPair("content", content),
                    new HttpPair("could_comment", couldComment),
                    new HttpPair("ctype", ctype),
                    new HttpPair("benefit", benefit),
                    new HttpPair("ext_tags", extTags),
                    new HttpPair("login_ids", loginIds)
                ...
                if (_kernel.isCertMode()) {
                    if (_kernel.verify(respMap, _kernel.extractAlipayPublicKey(_kernel.getAlipayCertSN(respMap)))) {
                        return HttpModel.toModel(_kernel.toRespModel(respMap), new AlipayOpenPublicMessageContentModifyResponse());
                    }
    ...
    public AlipayOpenPublicMessageTotalSendResponse sendText(String text) throws Exception {
        ...
        while (Http.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                HttpRequest request_ = new HttpRequest();
                java.util.Map<String, String> systemParams = HttpConverter.buildMap(
                    new HttpPair("method", "alipay.open.public.message.total.send"),
                    new HttpPair("app_id", _kernel.getConfig("appId")),
                    new HttpPair("timestamp", _kernel.getTimestamp()),
                    new HttpPair("format", "json"),
                    new HttpPair("version", "1.0"),
                ...
                Text textObj = Text.build(HttpConverter.buildMap(
                    new HttpPair("title", ""),
                    new HttpPair("content", text)
                ));
                java.util.Map<String, Object> bizParams = HttpConverter.buildMap(
                    new HttpPair("msg_type", "text"),
                    new HttpPair("text", textObj)
                );
                java.util.Map<String, String> textParams = new java.util.HashMap<>();
                request_.protocol = _kernel.getConfig("protocol");
                request_.method = "POST";
                ...
                if (_kernel.isCertMode()) {
                    if (_kernel.verify(respMap, _kernel.extractAlipayPublicKey(_kernel.getAlipayCertSN(respMap)))) {
                        return HttpModel.toModel(_kernel.toRespModel(respMap), new AlipayOpenPublicMessageTotalSendResponse());
                    }
    ...
    public AlipayOpenPublicMessageTotalSendResponse sendImageText(java.util.List<Article> articles) throws Exception {
        ...
        while (Http.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                ...
                java.util.Map<String, Object> bizParams = HttpConverter.buildMap(
                    new HttpPair("msg_type", "image-text"),
                    new HttpPair("articles", articles)
                );
                java.util.Map<String, String> textParams = new java.util.HashMap<>();
                request_.protocol = _kernel.getConfig("protocol");
                request_.method = "POST";
    ...
    public AlipayOpenPublicMessageSingleSendResponse sendSingleMessage(String toUserId, Template template) throws Exception {
        HttpModel.validateParams(template, "template");
        java.util.Map<String, Object> runtime_ = HttpConverter.buildMap(
            new HttpPair("ignoreSSL", _kernel.getConfig("ignoreSSL")),
            new HttpPair("httpProxy", _kernel.getConfig("httpProxy")),
            new HttpPair("connectTimeout", 15000),
        ...
        while (Http.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                HttpRequest request_ = new HttpRequest();
                java.util.Map<String, String> systemParams = HttpConverter.buildMap(
                    new HttpPair("method", "alipay.open.public.message.single.send"),
                    new HttpPair("app_id", _kernel.getConfig("appId")),
                    new HttpPair("timestamp", _kernel.getTimestamp()),
                    new HttpPair("format", "json"),
                    new HttpPair("version", "1.0"),
                ...
                java.util.Map<String, Object> bizParams = HttpConverter.buildMap(
                    new HttpPair("to_user_id", toUserId),
                    new HttpPair("template", template)
                );
                java.util.Map<String, String> textParams = new java.util.HashMap<>();
                request_.protocol = _kernel.getConfig("protocol");
                request_.method = "POST";
                ...
                if (_kernel.isCertMode()) {
                    if (_kernel.verify(respMap, _kernel.extractAlipayPublicKey(_kernel.getAlipayCertSN(respMap)))) {
                        return HttpModel.toModel(_kernel.toRespModel(respMap), new AlipayOpenPublicMessageSingleSendResponse());
                    }
    ...
    public AlipayOpenPublicLifeMsgRecallResponse recallMessage(String messageId) throws Exception {
        ...
        while (Http.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                HttpRequest request_ = new HttpRequest();
                java.util.Map<String, String> systemParams = HttpConverter.buildMap(
                    new HttpPair("method", "alipay.open.public.life.msg.recall"),
                    new HttpPair("app_id", _kernel.getConfig("appId")),
                    new HttpPair("timestamp", _kernel.getTimestamp()),
                    new HttpPair("format", "json"),
                    new HttpPair("version", "1.0"),
                ...
                java.util.Map<String, Object> bizParams = HttpConverter.buildMap(
                    new HttpPair("message_id", messageId)
                );
                java.util.Map<String, String> textParams = new java.util.HashMap<>();
                request_.protocol = _kernel.getConfig("protocol");
                request_.method = "POST";
                ...
                if (_kernel.isCertMode()) {
                    if (_kernel.verify(respMap, _kernel.extractAlipayPublicKey(_kernel.getAlipayCertSN(respMap)))) {
                        return HttpModel.toModel(_kernel.toRespModel(respMap), new AlipayOpenPublicLifeMsgRecallResponse());
                    }
    ...
    public AlipayOpenPublicTemplateMessageIndustryModifyResponse setIndustry(String primaryIndustryCode, String primaryIndustryName, String secondaryIndustryCode, String secondaryIndustryName) throws Exception {
        ...
        while (Http.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                HttpRequest request_ = new HttpRequest();
                java.util.Map<String, String> systemParams = HttpConverter.buildMap(
                    new HttpPair("method", "alipay.open.public.template.message.industry.modify"),
                    new HttpPair("app_id", _kernel.getConfig("appId")),
                    new HttpPair("timestamp", _kernel.getTimestamp()),
                    new HttpPair("format", "json"),
                    new HttpPair("version", "1.0"),
                ...
                java.util.Map<String, Object> bizParams = HttpConverter.buildMap(
                    new HttpPair("primary_industry_code", primaryIndustryCode),
                    new HttpPair("primary_industry_name", primaryIndustryName),
                    new HttpPair("secondary_industry_code", secondaryIndustryCode),
                    new HttpPair("secondary_industry_name", secondaryIndustryName)
                );
                java.util.Map<String, String> textParams = new java.util.HashMap<>();
                request_.protocol = _kernel.getConfig("protocol");
                request_.method = "POST";
                ...
                if (_kernel.isCertMode()) {
                    if (_kernel.verify(respMap, _kernel.extractAlipayPublicKey(_kernel.getAlipayCertSN(respMap)))) {
                        return HttpModel.toModel(_kernel.toRespModel(respMap), new AlipayOpenPublicTemplateMessageIndustryModifyResponse());
                    }
    ...
    public AlipayOpenPublicSettingCategoryQueryResponse getIndustry() throws Exception {
        ...
        while (Http.allowRetry((java.util.Map<String, Object>) runtime_.get("retry"), _retryTimes, _now)) {
            ...
            try {
                HttpRequest request_ = new HttpRequest();
                java.util.Map<String, String> systemParams = HttpConverter.buildMap(
                    new HttpPair("method", "alipay.open.public.setting.category.query"),
                    new HttpPair("app_id", _kernel.getConfig("appId")),
                    new HttpPair("timestamp", _kernel.getTimestamp()),
                    new HttpPair("format", "json"),
                    new HttpPair("version", "1.0"),
                ...
                if (_kernel.isCertMode()) {
                    if (_kernel.verify(respMap, _kernel.extractAlipayPublicKey(_kernel.getAlipayCertSN(respMap)))) {
                        return HttpModel.toModel(_kernel.toRespModel(respMap), new AlipayOpenPublicSettingCategoryQueryResponse());
                    }
