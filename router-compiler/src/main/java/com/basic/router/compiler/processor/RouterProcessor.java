...
import com.basic.router.compiler.util.Consts;
import com.basic.router.compiler.util.Logger;
import com.basic.router.compiler.util.TypeUtils;
...
import static com.basic.router.compiler.util.Consts.ACTIVITY;
import static com.basic.router.compiler.util.Consts.ANNOTATION_TYPE_AUTOWIRED;
import static com.basic.router.compiler.util.Consts.ANNOTATION_TYPE_ROUTE;
import static com.basic.router.compiler.util.Consts.FRAGMENT;
import static com.basic.router.compiler.util.Consts.IPROVIDER_GROUP;
import static com.basic.router.compiler.util.Consts.IROUTE_GROUP;
import static com.basic.router.compiler.util.Consts.ITROUTE_ROOT;
import static com.basic.router.compiler.util.Consts.KEY_MODULE_NAME;
import static com.basic.router.compiler.util.Consts.METHOD_LOAD_INTO;
import static com.basic.router.compiler.util.Consts.NAME_OF_GROUP;
import static com.basic.router.compiler.util.Consts.NAME_OF_PROVIDER;
import static com.basic.router.compiler.util.Consts.NAME_OF_ROOT;
import static com.basic.router.compiler.util.Consts.PACKAGE_OF_GENERATE_FILE;
import static com.basic.router.compiler.util.Consts.PREFIX_OF_LOGGER;
import static com.basic.router.compiler.util.Consts.SERVICE;
import static com.basic.router.compiler.util.Consts.WARNING_TIPS;
