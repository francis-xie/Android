...
import com.basic.log.strategy.format.DiskFormatStrategy;
import com.basic.log.strategy.format.IFormatStrategy;
import com.basic.log.strategy.format.PrettyFormatStrategy;
...
public final class LoggerFactory {
     ...
     * 获取磁盘打印的打印策略
     *
     * @param logDir       日志文件存储的根目录 【默认为"log"】
     ...
     * 获取磁盘打印的打印策略
     *
     * @param logDir    日志文件存储的根目录 日志文件存储的根目录 【默认为"log"】
