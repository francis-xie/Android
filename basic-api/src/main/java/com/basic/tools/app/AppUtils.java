...
import com.basic.tools.common.ShellUtils;
import com.basic.tools.common.logger.Logger;
import com.basic.tools.file.CleanUtils;
...
public final class AppUtils {
    ...
    public static void installApp(final File file, final String authority) {
        ...
        Util.getContext().startActivity(IntentUtils.getInstallAppIntent(file, authority, true));
    }
    ...
    public static boolean installAppSilent(final String filePath) {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.N) {
            return installAppSilentBelow24(Util.getContext(), filePath);
        } else {
            return installAppSilentAbove24(Util.getContext().getPackageName(), filePath);
        }
    }
    ...
    public static void uninstallApp(final String packageName) {
        ...
        Util.getContext().startActivity(IntentUtils.getUninstallAppIntent(packageName, true));
    }
    ...
    public static void launchApp(final String packageName) {
        ...
        Util.getContext().startActivity(IntentUtils.getLaunchAppIntent(packageName, true));
    }
    ...
    public static void exitApp() {
        if (Util.getActivityLifecycleHelper() != null) {
            Util.getActivityLifecycleHelper().exit();
        }
        ServiceUtils.stopAllRunningService(Util.getContext());
    ...
    public static void rebootApp(int delayMillis) {
        Intent intent = IntentUtils.getLaunchAppIntent(Util.getContext().getPackageName());
        PendingIntent restartIntent = PendingIntent.getActivity(Util.getContext(), 0, intent, PendingIntent.FLAG_ONE_SHOT);
        AlarmManager mgr = Util.getSystemService(Context.ALARM_SERVICE, AlarmManager.class);
        if (mgr != null) {
            // 1秒钟后重启应用
    ...
    public static void getAppDetailsSettings() {
        getAppDetailsSettings(Util.getContext().getPackageName());
    }
    ...
    public static void getAppDetailsSettings(final String packageName) {
        ...
        Util.getContext().startActivity(IntentUtils.getAppDetailsSettingsIntent(packageName, true));
    }
    ...
    public static boolean isSystemApp() {
        return isSystemApp(Util.getContext().getPackageName());
    }
    ...
    public static boolean isAppDebug() {
        return isAppDebug(Util.getContext().getPackageName());
    }
    ...
    public static Signature[] getAppSignature() {
        return getAppSignature(Util.getContext().getPackageName());
    }
    ...
    public static String getAppSignatureSHA1() {
        return getAppSignatureSHA1(Util.getContext().getPackageName());
    }
    ...
    public static boolean isAppForeground() {
        ...
        for (ActivityManager.RunningAppProcessInfo aInfo : info) {
            if (aInfo.importance == ActivityManager.RunningAppProcessInfo.IMPORTANCE_FOREGROUND) {
                return aInfo.processName.equals(Util.getContext().getPackageName());
            }
        }
        return false;
    }
    ...
    public static ActivityManager getActivityManager() {
        return (ActivityManager) Util.getContext().getSystemService(Context.ACTIVITY_SERVICE);
    }
    ...
    public static AppInfo getAppInfo() {
        return getAppInfo(Util.getContext().getPackageName());
    }
    ...
    public static PackageManager getPackageManager() {
        return Util.getContext().getPackageManager();
    }
