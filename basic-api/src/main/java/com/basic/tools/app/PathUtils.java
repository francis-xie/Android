...
import com.basic.constant.PathConstants;
...
public final class PathUtils {
    ...
    public static String getAppIntCachePath() {
        return Util.getContext().getCacheDir().getAbsolutePath();
    }
    ...
    public static String getAppIntFilesPath() {
        return Util.getContext().getFilesDir().getAbsolutePath();
    }
    ...
    public static String getAppIntDbPath(String name) {
        return Util.getContext().getDatabasePath(name).getAbsolutePath();
    }
    ...
    public static String getAppExtCachePath() {
        return getFilePath(Util.getContext().getExternalCacheDir());
    }
    ...
    public static String getAppExtFilePath() {
        return getFilePath(Util.getContext().getExternalFilesDir(null));
    }
    ...
    public static String getAppExtAlarmsPath() {
        return getFilePath(Util.getContext().getExternalFilesDir(Environment.DIRECTORY_ALARMS));
    }
    ...
    public static String getAppExtDCIMPath() {
        return getFilePath(Util.getContext().getExternalFilesDir(Environment.DIRECTORY_DCIM));
    }
    ...
    public static String getAppExtDocumentsPath() {
        return getFilePath(Util.getContext().getExternalFilesDir(Environment.DIRECTORY_DOCUMENTS));
    }
    ...
    public static String getAppExtDownloadPath() {
        return getFilePath(Util.getContext().getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS));
    }
    ...
    public static String getAppExtMoviesPath() {
        return getFilePath(Util.getContext().getExternalFilesDir(Environment.DIRECTORY_MOVIES));
    }
    ...
    public static String getAppExtMusicPath() {
        return getFilePath(Util.getContext().getExternalFilesDir(Environment.DIRECTORY_MUSIC));
    }
    ...
    public static String getAppExtNotificationsPath() {
        return getFilePath(Util.getContext().getExternalFilesDir(Environment.DIRECTORY_NOTIFICATIONS));
    }
    ...
    public static String getAppExtPicturesPath() {
        return getFilePath(Util.getContext().getExternalFilesDir(Environment.DIRECTORY_PICTURES));
    }
    ...
    public static String getAppExtPodcastsPath() {
        return getFilePath(Util.getContext().getExternalFilesDir(Environment.DIRECTORY_PODCASTS));
    }
    ...
    public static String getAppExtRingtonesPath() {
        return getFilePath(Util.getContext().getExternalFilesDir(Environment.DIRECTORY_RINGTONES));
    }
    ...
    public static String getObbPath() {
        return Util.getContext().getObbDir().getAbsolutePath();
    }
    ...
    public static Uri getMediaContentUri(File mediaFile) {
        return getMediaContentUri(Util.getContext(), mediaFile);
    }
    ...
    public static Uri getUriForFile(final File file) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
            String authority = Util.getContext().getPackageName() + ".util.provider";
            return FileProvider.getUriForFile(Util.getContext(), authority, file);
        } else {
    ...
    public static File uri2File(final Uri uri, final String columnName) {
        ...
        CursorLoader cl = new CursorLoader(Util.getContext());
        cl.setUri(uri);
    ...
    public static String getFilePathByUri(Uri uri) {
        return getFilePathByUri(Util.getContext(), uri);
    }
