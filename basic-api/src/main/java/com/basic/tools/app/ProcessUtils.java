...
public final class ProcessUtils {
    ...
    public static String getForegroundProcessName() {
        ActivityManager manager =
                (ActivityManager) Util.getContext().getSystemService(Context.ACTIVITY_SERVICE);
        if (manager == null) {
            return null;
        }
        ...
        if (android.os.Build.VERSION.SDK_INT > android.os.Build.VERSION_CODES.LOLLIPOP) {
            ...
            try {// 有"有权查看使用权限的应用"选项
                ApplicationInfo info =
                        packageManager.getApplicationInfo(Util.getContext().getPackageName(), 0);
                AppOpsManager aom =
                        (AppOpsManager) Util.getContext().getSystemService(Context.APP_OPS_SERVICE);
                if (aom != null) {
                ...
                UsageStatsManager usageStatsManager = (UsageStatsManager) Util.getContext()
    ...
    public static int gc() {
        ...
        int count = 0; // 清理掉的进程数
        ActivityManager am = (ActivityManager) Util.getContext().getSystemService(Context.ACTIVITY_SERVICE);
        // 获取正在运行的service列表
    ...
    public static boolean isMainProcess() {
        return Util.getContext().getPackageName().equals(getCurrentProcessName());
    }
