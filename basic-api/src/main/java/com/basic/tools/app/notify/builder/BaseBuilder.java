...
import com.basic.tools.app.notify.NotificationUtils;
...
public class BaseBuilder {
    private static final String DEFAULT_CHANNEL_ID_PREFIX = "util_channel_id_";
    private static final String DEFAULT_CHANNEL_NAME_PREFIX = "util_channel_name_";
    ...
    public void build() {
        ...
        mBuilder = new NotificationCompat.Builder(Util.getContext(), mChannelId);
