...
public final class ScreenUtils {
    ...
    public static int getScreenWidth() {
        WindowManager wm = Util.getSystemService(Context.WINDOW_SERVICE, WindowManager.class);
        if (wm == null) {
    ...
    public static boolean isScreenLock() {
        KeyguardManager km =
                (KeyguardManager) Util.getContext().getSystemService(Context.KEYGUARD_SERVICE);
    ...
    public static void cancelAdaptScreen(final Activity activity) {
        final DisplayMetrics appDm = Util.getContext().getResources().getDisplayMetrics();
