...
import com.basic.constant.PermissionConstants;
import com.basic.constant.PermissionConstants.Permission;
import com.basic.tools.Util;
import com.basic.tools.system.PermissionUtils.OnRationaleListener.ShouldRequest;
...
public final class PermissionUtils {
    ...
    public static List<String> getPermissions() {
        return getPermissions(Util.getContext().getPackageName());
    }
    ...
    private static boolean isGranted(final String permission) {
        return Build.VERSION.SDK_INT < Build.VERSION_CODES.M
                ...
                == ContextCompat.checkSelfPermission(Util.getContext(), permission);
    }
    ...
    public static void openAppSettings() {
        ...
        intent.setData(Uri.parse("package:" + Util.getContext().getPackageName()));
        Util.getContext().startActivity(intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
    }
    ...
    private void startPermissionActivity() {
        ...
        PermissionActivity.start(Util.getContext());
    }
