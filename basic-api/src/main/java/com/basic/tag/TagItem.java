...
import com.basic.tag.animate.Animatable;
import com.basic.tag.badgeview.BadgeRelativeLayout;
import com.basic.tag.badgeview.Badgeable;
import com.basic.tag.badgeview.DragDismissDelegate;
...
public class TagItem extends BadgeRelativeLayout {
    ...
    private void initImageView() {
        ...
        RelativeLayout.LayoutParams params = new RelativeLayout.LayoutParams(
                mIconSize, mIconSize);
        params.addRule(mTitle == null ? CENTER_IN_PARENT : CENTER_HORIZONTAL);
        if (mTitle != null)
