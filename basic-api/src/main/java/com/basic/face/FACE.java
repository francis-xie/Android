...
public class FACE {
    ...
    private static void testInitialize() {
        if (sContext == null) {
            throw new ExceptionInInitializerError("请先在全局Application中调用 FACE.init() 初始化！");
        }
    }
    ...
    public static int getScreenType() {
        ...
        sScreenType = checkScreenSize(FACE.getContext());
    ...
    public static void initTheme(Activity activity) {
        ...
        if (screenType == UIConsts.ScreenType.PHONE) {
            activity.setTheme(R.style.FACETheme_Phone);
        } else if (screenType == UIConsts.ScreenType.SMALL_TABLET) {
            activity.setTheme(R.style.FACETheme_Tablet_Small);
        } else {
            activity.setTheme(R.style.FACETheme_Tablet_Big);
        }
    }
