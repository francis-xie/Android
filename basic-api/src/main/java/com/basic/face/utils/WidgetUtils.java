...
import com.basic.face.adapter.recyclerview.XGridLayoutManager;
...
public final class WidgetUtils {
    ...
    public static void initSpinnerStyle(@NonNull Spinner spinner) {
        // 带下拉箭头的背景
        spinner.setBackground(ResUtils.getDrawable(spinner.getContext(), R.drawable.face_config_bg_spinner));
    ...
    public static void initSpinnerItem(@NonNull Spinner spinner, @NonNull String[] items) {
        ArrayAdapter<String> adapter = new ArrayAdapter<>(spinner.getContext(), R.layout.face_layout_spinner_selected_item, R.id.spinner_item, items);
        adapter.setDropDownViewResource(R.layout.face_layout_spinner_drop_down_item);
    ...
    public static void setTabLayoutTextFont(TabLayout tabLayout) {
        setTabLayoutTextFont(tabLayout, FACE.getDefaultTypeface());
    }
