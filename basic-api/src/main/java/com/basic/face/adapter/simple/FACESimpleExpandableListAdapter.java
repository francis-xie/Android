...
public class FACESimpleExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    private int mArrowUpResId = R.drawable.face_ic_expand_arrow_up;
    private int mArrowDownResId = R.drawable.face_ic_expand_arrow_down;

    public FACESimpleExpandableListAdapter(List<ExpandableItem> data) {
        mData = data;
    }

    public FACESimpleExpandableListAdapter(ExpandableItem... data) {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.face_layout_expand_group_item, parent, false);
    ...
    public View getChildView(int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(parent.getContext()).inflate(R.layout.face_layout_expand_child_item, parent, false);
            ...
            if (mPaddingStartPx != 0) {
                int padding = ThemeUtils.resolveDimension(parent.getContext(), R.attr.face_config_content_spacing_vertical);
    ...
    @Deprecated
    public FACESimpleExpandableListAdapter setPaddingLeftPx(int paddingLeftPx) {
        mPaddingStartPx = paddingLeftPx;
        return this;
    }

    @Deprecated
    public FACESimpleExpandableListAdapter setPaddingLeftDp(int paddingLeftDp) {
        mPaddingStartPx = DensityUtils.dp2px(paddingLeftDp);
        return this;
    }

    public FACESimpleExpandableListAdapter setPaddingStartPx(int paddingStartPx) {
        mPaddingStartPx = paddingStartPx;
        return this;
    }

    public FACESimpleExpandableListAdapter setPaddingStartDp(int paddingStartDp) {
     ...
     * @return
     */
    public FACESimpleExpandableListAdapter setArrowStyle(int arrowDownResId, int arrowUpResId) {
