...
package com.basic.face.widget.actionbar;
...
import com.basic.face.widget.alpha.FACEAlphaTextView;
import com.basic.face.widget.textview.AutoMoveTextView;
...
public class TitleBar extends ViewGroup implements View.OnClickListener, HasTypeface {
    ...
    private FACEAlphaTextView mLeftText;
    private FACEAlphaLinearLayout mCenterLayout;
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBarHeight = typedArray.getDimensionPixelSize(R.styleable.TitleBar_tb_barHeight, ThemeUtils.resolveDimension(context, R.attr.face_actionbar_height));
        mImmersive = typedArray.getBoolean(R.styleable.TitleBar_tb_immersive, ThemeUtils.resolveBoolean(context, R.attr.face_actionbar_immersive));

        mActionPadding = typedArray.getDimensionPixelSize(R.styleable.TitleBar_tb_actionPadding, ThemeUtils.resolveDimension(context, R.attr.face_actionbar_action_padding));
        mSideTextPadding = typedArray.getDimensionPixelSize(R.styleable.TitleBar_tb_sideTextPadding, ThemeUtils.resolveDimension(context, R.attr.face_actionbar_side_text_padding));
        mCenterGravity = typedArray.getInt(R.styleable.TitleBar_tb_centerGravity, CENTER_CENTER);

        mSideTextSize = typedArray.getDimensionPixelSize(R.styleable.TitleBar_tb_sideTextSize, ThemeUtils.resolveDimension(context, R.attr.face_actionbar_action_text_size));
        mTitleTextSize = typedArray.getDimensionPixelSize(R.styleable.TitleBar_tb_titleTextSize, ThemeUtils.resolveDimension(context, R.attr.face_actionbar_title_text_size));
        mSubTitleTextSize = typedArray.getDimensionPixelSize(R.styleable.TitleBar_tb_subTitleTextSize, ThemeUtils.resolveDimension(context, R.attr.face_actionbar_sub_text_size));
        mActionTextSize = typedArray.getDimensionPixelSize(R.styleable.TitleBar_tb_actionTextSize, ThemeUtils.resolveDimension(context, R.attr.face_actionbar_action_text_size));

        mSideTextColor = typedArray.getColor(R.styleable.TitleBar_tb_sideTextColor, ThemeUtils.resolveColor(getContext(), R.attr.face_actionbar_text_color, Color.WHITE));
        mTitleTextColor = typedArray.getColor(R.styleable.TitleBar_tb_titleTextColor, ThemeUtils.resolveColor(getContext(), R.attr.face_actionbar_text_color, Color.WHITE));
        mSubTitleTextColor = typedArray.getColor(R.styleable.TitleBar_tb_subTitleTextColor, ThemeUtils.resolveColor(getContext(), R.attr.face_actionbar_text_color, Color.WHITE));
        mActionTextColor = typedArray.getColor(R.styleable.TitleBar_tb_actionTextColor, ThemeUtils.resolveColor(getContext(), R.attr.face_actionbar_text_color, Color.WHITE));
    ...
    private void initView(Context context) {
        mLeftText = new FACEAlphaTextView(context);
        mCenterLayout = new FACEAlphaLinearLayout(context);
        ...
        mLeftText.setTypeface(FACE.getDefaultTypeface());
        ...
        mCenterText.setTypeface(FACE.getDefaultTypeface());
        ...
        mSubTitleText.setTypeface(FACE.getDefaultTypeface());
        ...
        if (mIsUseThemeColor) {
            Drawable backgroundDrawable = ThemeUtils.resolveDrawable(getContext(), R.attr.face_actionbar_background);
            if (backgroundDrawable != null) {
                setBackground(backgroundDrawable);
            } else {
                setBackgroundColor(ThemeUtils.resolveColor(context, R.attr.face_actionbar_color));
            }
        }
    }
    ...
    protected View inflateAction(Action action) {
        ...
        if (TextUtils.isEmpty(action.getText())) {
            ImageView img = new FACEAlphaImageView(getContext());
            img.setImageResource(action.getDrawable());
            view = img;
        } else {
            TextView text = new FACEAlphaTextView(getContext());
            ...
            text.setTypeface(FACE.getDefaultTypeface());
    ...
    public FACEAlphaTextView getLeftText() {
        return mLeftText;
    }
