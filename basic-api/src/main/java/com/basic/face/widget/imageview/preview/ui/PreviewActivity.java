...
package com.basic.face.widget.imageview.preview.ui;
...
import com.basic.R;
import com.basic.face.utils.CollectionUtils;
import com.basic.face.widget.imageview.preview.MediaLoader;
...
import com.basic.face.widget.imageview.preview.view.BezierBannerView;
import com.basic.face.widget.imageview.preview.view.PhotoViewPager;
import com.basic.face.widget.imageview.preview.view.SmoothImageView;

import java.util.ArrayList;
import java.util.List;

import static com.basic.face.widget.imageview.preview.ui.BasePhotoFragment.KEY_DRAG;
import static com.basic.face.widget.imageview.preview.ui.BasePhotoFragment.KEY_PROGRESS_COLOR;
import static com.basic.face.widget.imageview.preview.ui.BasePhotoFragment.KEY_SENSITIVITY;
import static com.basic.face.widget.imageview.preview.ui.BasePhotoFragment.KEY_SING_FILING;
...
public class PreviewActivity extends AppCompatActivity {
    ...
    public static final String KEY_POSITION = "com.basic.face.widget.preview.KEY_POSITION";
    public static final String KEY_TYPE = "com.basic.face.widget.preview.KEY_TYPE";
    public static final String KEY_IS_SHOW = "com.basic.face.widget.preview.KEY_IS_SHOW";
    public static final String KEY_DURATION = "com.basic.face.widget.preview.KEY_DURATION";
    public static final String KEY_IS_FULLSCREEN = "com.basic.face.widget.preview.KEY_IS_FULLSCREEN";
    public static final String KEY_CLASSNAME = "com.basic.face.widget.preview.KEY_CLASSNAME";
            ...
            for (int i = 0; i < size; i++) {
                fragments.add(BasePhotoFragment.
                        newInstance(className, imgUrls.get(i),
                                ...
                                getIntent().getIntExtra(KEY_PROGRESS_COLOR, R.color.face_config_color_main_theme))
                );
            }
        } else {
            finish();
    ...
    private void initView() {
        ...
        if (mType == PreviewBuilder.IndicatorType.Dot) {
            ...
            mTvIndex.setText(getString(R.string.face_preview_count_string, (mCurrentIndex + 1), getImgSize()));
            mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
                ...
                public void onPageSelected(int position) {
                    //当被选中的时候设置小圆点和当前位置
                    if (mTvIndex != null) {
                        mTvIndex.setText(getString(R.string.face_preview_count_string, (position + 1), getImgSize()));
                    }
