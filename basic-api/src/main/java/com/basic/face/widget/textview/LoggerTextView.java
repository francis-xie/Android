...
package com.basic.face.widget.textview;
...
public class LoggerTextView extends AppCompatTextView {
    ...
    public static class DefaultLogDecorator implements ILogDecorator {
        ...
        public SpannableString decorate(String logContent, LogType logType) {
            ...
            switch (logType) {
                case ERROR:
                    spannableString.setSpan(new ForegroundColorSpan(ResUtils.getColor(R.color.face_config_color_error)),
                            0,
                            logContent.length(),
                            Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                    break;
                case SUCCESS:
                    spannableString.setSpan(new ForegroundColorSpan(ResUtils.getColor(R.color.face_config_color_success)),
                            0,
                            logContent.length(),
                            Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                    break;
                case WARNING:
                    spannableString.setSpan(new ForegroundColorSpan(ResUtils.getColor(R.color.face_config_color_waring)),
                            0,
                            logContent.length(),
                            Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
                    break;
