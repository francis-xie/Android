...
public class EasyIndicator extends LinearLayout implements View.OnClickListener, ViewPager.OnPageChangeListener, HasTypeface {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        indicatorBottomLineColor = typedArray.getColor(R.styleable.EasyIndicator_indicator_bottom_line_color, ThemeUtils.resolveColor(getContext(), R.attr.face_config_color_separator_dark));
        ...
        indicatorNormalColor = typedArray.getColor(R.styleable.EasyIndicator_indicator_normal_color, ResUtils.getColor(R.color.face_config_color_black));
        ...
        indicatorVerticalLineColor = typedArray.getColor(R.styleable.EasyIndicator_indicator_vertical_line_color, ThemeUtils.resolveColor(getContext(), R.attr.face_config_color_separator_dark));
    ...
    public void setTabTitles(String[] tabTitles) {
        ...
        for (int i = 0; i < tabTitles.length; i++) {
            ...
            view.setTypeface(FACE.getDefaultTypeface());
