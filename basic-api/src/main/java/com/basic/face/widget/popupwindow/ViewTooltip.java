package com.basic.face.widget.popupwindow;
...
public class ViewTooltip {
    ...
    public static class TooltipView extends FrameLayout {
        ...
        public TooltipView(Context context) {
            ...
            mPaddingTop = mPaddingBottom = ThemeUtils.resolveDimension(getContext(), R.attr.face_tip_popup_padding_top);
            mPaddingRight = mPaddingLeft = ThemeUtils.resolveDimension(getContext(), R.attr.face_tip_popup_padding_left);

            setTextTypeFace(FACE.getDefaultTypeface());
        }
