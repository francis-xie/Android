package com.basic.face.widget.textview.supertextview;
...
import com.basic.face.widget.edittext.ClearEditText;
import com.basic.face.widget.edittext.PasswordEditText;
...
public class SuperTextView extends RelativeLayout implements HasTypeface {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mDefaultShapeColor = ThemeUtils.resolveColor(context, R.attr.stv_color_shape, ResUtils.getColor(R.color.face_config_color_white));
    ...
    private void getAttr(AttributeSet attrs) {
        ...
        mDividerLineColor = typedArray.getColor(R.styleable.SuperTextView_sDividerLineColor, ThemeUtils.resolveColor(getContext(), R.attr.face_config_color_separator_light));
    ...
    private void initCenterTextView() {
        if (mEnableEdit) {
            ...
            if (mEditBackground != null) {
                ...
                mCenterEditText.setBackgroundColor(ResUtils.getColor(R.color.face_config_color_transparent));
            }
