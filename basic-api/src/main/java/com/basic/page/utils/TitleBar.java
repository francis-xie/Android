...
public class TitleBar extends ViewGroup implements View.OnClickListener {
    ...
    public TitleBar(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.PageTitleBarStyle);
    }
    ...
    private void initAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (typedArray != null) {
            mBarHeight = typedArray.getDimensionPixelSize(R.styleable.TitleBar_tb_barHeight, Utils.resolveDimension(context, R.attr.page_actionbar_height, Utils.getDimensionPixelSize(getContext(), R.dimen.page_default_actionbar_height)));
            mImmersive = typedArray.getBoolean(R.styleable.TitleBar_tb_immersive, Utils.resolveBoolean(context, R.attr.page_actionbar_immersive));

            mActionPadding = typedArray.getDimensionPixelSize(R.styleable.TitleBar_tb_actionPadding, Utils.resolveDimension(context, R.attr.page_actionbar_action_padding, Utils.getDimensionPixelSize(getContext(), R.dimen.page_default_action_padding)));
            mSideTextPadding = typedArray.getDimensionPixelSize(R.styleable.TitleBar_tb_sideTextPadding, Utils.resolveDimension(context, R.attr.page_actionbar_side_text_padding, Utils.getDimensionPixelSize(getContext(), R.dimen.page_default_sidetext_padding)));
            mCenterGravity = typedArray.getInt(R.styleable.TitleBar_tb_centerGravity, CENTER_CENTER);

            mSideTextSize = typedArray.getDimensionPixelSize(R.styleable.TitleBar_tb_sideTextSize, Utils.resolveDimension(context, R.attr.page_actionbar_action_text_size, Utils.getDimensionPixelSize(getContext(), R.dimen.page_default_action_text_size)));
            mTitleTextSize = typedArray.getDimensionPixelSize(R.styleable.TitleBar_tb_titleTextSize, Utils.resolveDimension(context, R.attr.page_actionbar_title_text_size, Utils.getDimensionPixelSize(getContext(), R.dimen.page_default_title_text_size)));
            mSubTitleTextSize = typedArray.getDimensionPixelSize(R.styleable.TitleBar_tb_subTitleTextSize, Utils.resolveDimension(context, R.attr.page_actionbar_sub_text_size, Utils.getDimensionPixelSize(getContext(), R.dimen.page_default_sub_text_size)));
            mActionTextSize = typedArray.getDimensionPixelSize(R.styleable.TitleBar_tb_actionTextSize, Utils.resolveDimension(context, R.attr.page_actionbar_action_text_size, Utils.getDimensionPixelSize(getContext(), R.dimen.page_default_action_text_size)));

            mSideTextColor = typedArray.getColor(R.styleable.TitleBar_tb_sideTextColor, Utils.resolveColor(getContext(), R.attr.page_actionbar_text_color, DEFAULT_TEXT_COLOR));
            mTitleTextColor = typedArray.getColor(R.styleable.TitleBar_tb_titleTextColor, Utils.resolveColor(getContext(), R.attr.page_actionbar_text_color, DEFAULT_TEXT_COLOR));
            mSubTitleTextColor = typedArray.getColor(R.styleable.TitleBar_tb_subTitleTextColor, Utils.resolveColor(getContext(), R.attr.page_actionbar_text_color, DEFAULT_TEXT_COLOR));
            mActionTextColor = typedArray.getColor(R.styleable.TitleBar_tb_actionTextColor, Utils.resolveColor(getContext(), R.attr.page_actionbar_text_color, DEFAULT_TEXT_COLOR));
    ...
    private void initView(Context context) {
        ...
        if (mIsUseThemeColor) {
            Drawable backgroundDrawable = Utils.resolveDrawable(getContext(), R.attr.page_actionbar_background);
            if (backgroundDrawable != null) {
                ...
                setBackgroundColor(Utils.resolveColor(context, R.attr.page_actionbar_color, getResources().getColor(R.color.page_default_actionbar_color)));
            }
        }
