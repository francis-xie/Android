...
import static com.basic.page.core.CoreSwitchBean.convertAnimations;
...
public class PageOption {
     ...
     * @return
     */
    public static <T extends PageFragment> PageOption to(Class<T> clazz) {
    ...
    public <T extends PageFragment> PageOption(Class<T> clazz) {
        setTargetPage(clazz);
    }
     ...
     * @return
     */
    public <T extends PageFragment> PageOption setTargetPage(Class<T> clazz) {
     ...
     * @return
     */
    public PageOption setContainActivityClazz(@NonNull Class<? extends PageActivity> containActivityClazz) {
    ...
    public PageOption setNewActivity(boolean newActivity, @NonNull Class<? extends PageActivity> containActivityClazz) {
        mNewActivity = newActivity;
        mContainActivityClassName = containActivityClazz.getCanonicalName();
        return this;
    }
     ...
     * @return
     */
    public Fragment open(@NonNull PageFragment fragment) {
        return fragment.openPage(this);
    }

    /**
     * 在PageFragment中使用，有返回值
     *
     * @param fragment
     * @param requestCode
     * @return
     */
    public Fragment openForResult(@NonNull PageFragment fragment, int requestCode) {
     ...
     * @return
     */
    public Fragment open(@NonNull PageActivity activity) {
