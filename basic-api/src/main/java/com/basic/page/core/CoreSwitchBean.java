...
public class CoreSwitchBean implements Parcelable {
    ...
    public static int[] convertAnimations(CoreAnim coreAnim) {
        if (coreAnim == CoreAnim.present) {
            return new int[]{R.anim.page_push_in_down, R.anim.page_push_no_anim, R.anim.page_push_no_anim, R.anim.page_push_out_down};
        } else if (coreAnim == CoreAnim.fade) {
            return new int[]{R.anim.page_alpha_in, R.anim.page_alpha_out, R.anim.page_alpha_in, R.anim.page_alpha_out};
        } else if (coreAnim == CoreAnim.slide) {
            return new int[]{R.anim.page_slide_in_right, R.anim.page_slide_out_left, R.anim.page_slide_in_left, R.anim.page_slide_out_right};
        } else if (coreAnim == CoreAnim.zoom) {
            return new int[]{R.anim.page_zoom_in, R.anim.page_zoom_out, R.anim.page_zoom_in, R.anim.page_zoom_out};
        }
        return null;
    }

    public <T extends PageFragment> CoreSwitchBean(Class<T> clazz, Bundle bundle) {
    ...
    public <T extends PageFragment> CoreSwitchBean(Class<T> clazz) {
        PageInfo pageInfo = PageConfig.getPageInfo(clazz);
        mPageName = pageInfo.getName();
        setAnim(pageInfo.getAnim());
    }
     ...
     * @return
     */
    public CoreSwitchBean setContainActivityClazz(@NonNull Class<? extends PageActivity> containActivityClazz) {
    ...
    public CoreSwitchBean setNewActivity(boolean newActivity, @NonNull Class<? extends PageActivity> containActivityClazz) {
        mNewActivity = newActivity;
        mContainActivityClassName = containActivityClazz.getCanonicalName();
        return this;
    }
