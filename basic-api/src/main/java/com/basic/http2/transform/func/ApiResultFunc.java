...
import static com.basic.http2.model.ApiResult.CODE;
import static com.basic.http2.model.ApiResult.DATA;
import static com.basic.http2.model.ApiResult.MSG;
...
public class ApiResultFunc<T> implements Function<ResponseBody, ApiResult<T>> {
    ...
    private void handleApiResult(Class clazz, Class rawType, ApiResult result) throws Exception {
        if (!Http.getInstance().isInStrictMode()) {
