...
# page
-keep class com.basic.page.annotation.** { *; }
-keep class com.basic.page.config.** { *; }

# aop
-keep @com.basic.aop.annotation.* class * {*;}
-keep @org.aspectj.lang.annotation.* class * {*;}
-keep class * {
    @com.basic.aop.annotation.* <fields>;
    @org.aspectj.lang.annotation.* <fields>;
}
-keepclassmembers class * {
    @com.basic.aop.annotation.* <methods>;
    @org.aspectj.lang.annotation.* <methods>;
}

# router
-keep public class com.basic.router.routes.**{*;}
-keep class * implements com.basic.router.facade.template.ISyringe{*;}
# 如果使用了 byType 的方式获取 Service，需添加下面规则，保护接口
-keep interface * implements com.basic.router.facade.template.IProvider
# 如果使用了 单类注入，即不定义接口实现 IProvider，需添加下面规则，保护实现
-keep class * implements com.basic.router.facade.template.IProvider
...
# web
-keep class com.basic.web.** {
    *;
}
-dontwarn com.basic.web.**
# Java 注入类不要混淆
-keepclassmembers class com.basic.code.fragment.expands.webview.AndroidInterface{ *; }
...
# 数据库
-keep class com.basic.code.base.db.entity.** { *; }

# PictureSelector
-keep class com.basic.image.** { *; }
-dontwarn com.basic.tailor**
-keep class com.basic.tailor** { *; }
-keep interface com.basic.tailor** { *; }
