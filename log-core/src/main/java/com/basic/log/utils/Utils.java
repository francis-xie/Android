...
import com.basic.log.logger.Logger;
...
import static com.basic.log.utils.FileUtils.ZIP_EXT;
...
public final class Utils {
        ...
        sExecutorService.submit(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    android.util.Log.e(TAG, "写日志异常", e);
                } finally {
    ...
    public static String getDeviceInfos() {
        return getDeviceInfos(Log.getContext());
    }
    ...
    public static int getStackOffset(StackTraceElement[] trace) {
        for (int i = MIN_STACK_OFFSET; i < trace.length; i++) {
            ...
            if (!name.equals(Log.class.getName()) && !name.equals(Logger.class.getName())) {
                return --i;
            }
        }
        return -1;
