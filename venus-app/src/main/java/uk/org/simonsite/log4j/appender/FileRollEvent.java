...
public final class FileRollEvent extends LoggingEvent {
   ...
   */
  FileRollEvent(final FileRoller source, final File backupFile) {
  ...
  private TimeAndSizeRollingAppender getSource() {
    if (this.source == null) {
      ...
      if (appender == null) {
        LogLog.error("Missing " + TimeAndSizeRollingAppender.class.getName()
      ...
      if (appender instanceof TimeAndSizeRollingAppender) {
        ...
        LogLog.error("Expected " + TimeAndSizeRollingAppender.class.getName()
  ...
  final void dispatchToAppender(final String message) {
    ...
    final TimeAndSizeRollingAppender appender = this.getSource();
    if (appender != null) {
