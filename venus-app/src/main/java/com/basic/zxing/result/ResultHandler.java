package com.basic.zxing.result;
...
import com.basic.zxing.util.Contents;
import com.basic.zxing.util.Intents;
import com.basic.zxing.util.LocaleManager;
...
/**
 * 特定于android的条形码处理程序的基类。这些允许应用程序多态
 * 为每种数据类型建议适当的操作。
 * <p>
 * 这个类还包含一组实用程序方法，用于执行打开URL等常见操作。
 * 它们可以很容易地移动到helper对象中，但它不能是静态的，因为活动
 * 需要实例来启动一个意图。
 */
