...
public final class TitleUtils {
    ...
    public static TitleBar initTitleBarStyle(TitleBar titleBar, String title, View.OnClickListener listener) {
        titleBar.setLeftImageDrawable(Utils.resolveDrawable(titleBar.getContext(), R.attr.page_actionbar_navigation_back, Utils.getVectorDrawable(titleBar.getContext(), R.drawable.page_ic_navigation_back_white)))
