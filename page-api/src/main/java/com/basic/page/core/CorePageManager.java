...
public class CorePageManager {
     ...
     * @return 是否新增成功
     */
    public boolean putPage(String name, Class<? extends PageFragment> clazz, Map<String, String> params) {
     ...
     */
    public PageFragment openPageWithNewFragmentManager(FragmentManager fragmentManager, String pageName, Bundle bundle, int[] animations, boolean addToBackStack) {
        ...
        try {
            ...
            fragment = loadPageFragmentByCorePage(corePage, pageName, bundle);
     ...
     * @return 打开的Fragment对象
     */
    public PageFragment changePageWithNewFragmentManager(FragmentManager fragmentManager, String pageName, Bundle bundle, int[] animations, boolean addToBackStack) {
        ...
        try {
            ...
            pageFragment = (PageFragment) fragmentManager.findFragmentByTag(pageName);

            if (pageFragment == null) {
                pageFragment = loadPageFragmentByCorePage(corePage, pageName, bundle);
                fragmentTransaction.add(R.id.fragment_container, pageFragment, pageName);
            } else {
    ...
    /**
     * 根据CorePage加载PageFragment
     *
     * @param corePage 页面配置信息
     * @param pageName 页面名
     * @param bundle   参数
     */
    private PageFragment loadPageFragmentByCorePage(CorePage corePage, String pageName, Bundle bundle) throws ClassNotFoundException, IllegalAccessException, InstantiationException {
        ...
        if (CoreConfig.isOpenAtlas()) {
            ...
            fragment = (PageFragment) CoreConfig.getBundleClassLoader().loadClass(corePage.getClazz()).newInstance();
        } else {
            fragment = (PageFragment) Class.forName(corePage.getClazz()).newInstance();
        }
        //====Atlas的支持 end====/
    ...
    public boolean isFragmentTop(Context context, String fragmentTag) {
        if (context instanceof CoreSwitcher) {
            ...
            PageActivity topActivity = PageActivity.getTopActivity();
