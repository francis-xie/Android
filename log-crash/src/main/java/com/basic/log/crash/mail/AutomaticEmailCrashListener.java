...
//                .setCcEmails(mCcEmails)
                    .setHost(mServerHost)
                    .setPort(mServerPort)
                    .setTitle(context.getString(R.string.log_title_crash_report_email) + "【" + TimeUtils.getCurTime("yyyy-MM-dd HH:mm:ss") + "】")
        ...
        try {
            ...
            sender.send();
            Toast.makeText(context, R.string.log_email_send_success, Toast.LENGTH_LONG).show();
        } catch (Exception e) {
            Toast.makeText(context, R.string.log_email_send_failed, Toast.LENGTH_LONG).show();
            e.printStackTrace();
        } finally { // 退出
            //禁止重启
