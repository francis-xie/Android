...
package com.basic.dbms.compiler;
...
import com.basic.dbms.util.Consts;
import com.basic.dbms.util.Logger;
...
public class DataBaseRepositoryProcessor extends AbstractProcessor {
    ...
    private static final ClassName DBServiceClassName = ClassName.get("com.basic.dbms.db", "DBService");
    private static final ClassName ContextClassName = ClassName.get("android.content", "Context");
    private static final ClassName IDatabaseClassName = ClassName.get("com.basic.dbms.db", "IDatabase");
    private static final ClassName IExternalDataBaseClassName = ClassName.get("com.basic.dbms.db", "IExternalDataBase");
    private static final ClassName DBLogClassName = ClassName.get("com.basic.dbms.logs", "DBLog");
     ...
     * 页面配置所在的包名
     */
    private static final String PACKAGE_NAME = "com.basic.dbms";
    ...
    private void parseDataBases(Set<? extends Element> dataBaseElements) throws IOException {
        if (CollectionUtils.isNotEmpty(dataBaseElements)) {
            ...
            CodeBlock javaDoc = CodeBlock.builder()
                    ...
                    .add("<p><a href=\"mailto:zhiqiang@163.com\">Contact me.</a></p>\n")
                    .add("\n")
                    .add("@author zhiqiang \n")
                ...
                if (mTypes.isSubtype(tm, mApplication)) {
                    ...
                    if (dataBase.type().equals(DataBaseType.EXTERNAL)) {
                        FieldSpec dbPathField = FieldSpec.builder(String.class, "DATABASE_PATH")
                                ...
                                .addModifiers(Modifier.STATIC)
                                .addModifiers(Modifier.FINAL)
                                .initializer("$S", !StringUtils.isEmpty(dataBase.path()) ? getDirPath(dataBase.path()) : "/storage/emulated/0/Android/dbms/databases/")
                                .build();
