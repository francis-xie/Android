...
public class Consts {
    ...
    public static final String PACKAGE_OF_ROUTER = "com.basic.router";
    ...
    public static final String PACKAGE_OF_GENERATE_FILE = PACKAGE_OF_ROUTER + ".routes";
    ...
    // Custom interface
    private static final String FACADE_PACKAGE = PACKAGE_OF_ROUTER+ ".facade";
    ...
    // Annotation type
    public static final String ANNOTATION_TYPE_INTECEPTOR = PACKAGE_OF_ROUTER + ".annotation.Interceptor";
    public static final String ANNOTATION_TYPE_ROUTE = PACKAGE_OF_ROUTER + ".annotation.Router";
    public static final String ANNOTATION_TYPE_AUTOWIRED = PACKAGE_OF_ROUTER + ".annotation.AutoWired";
}